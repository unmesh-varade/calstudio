...
import { DashboardBookingReschedulePage } from '../pages/dashboard-booking-reschedule-page'
...
import { PublicBookingCancelPage } from '../pages/public-booking-cancel-page'
import { PublicBookingPage } from '../pages/public-booking-page'
import { PublicBookingReschedulePage } from '../pages/public-booking-reschedule-page'
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/booking/:bookingId/reschedule', element: <PublicBookingReschedulePage /> },
      { path: '/booking/:bookingId/cancel', element: <PublicBookingCancelPage /> },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'bookings/:id/reschedule', element: <DashboardBookingReschedulePage /> },
    ],
  },
  {
    path: '*',
